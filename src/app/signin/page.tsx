...
//   return (
//     <Bare>
//       <div className='min-h-screen w-full bg-red-100 flex '>
//         <div className="w-2/4 bg-white flex flex-col gap-10 text-center">
//           <Logo />
//           <div className='p-24'>
//             <h1 className="text-2xl font-semibold text-center flex">Sign in</h1>
//             {/** Form */}
//             <FormLogin />
//           </div>
//         </div>
      ...
      <div className="min-h-screen w-full flex">
        ...
        <div className="flex flex-col p-16 text-white">
                  ...
                  <div className="flex gap-4">
                    <Image 
  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQmixgImUBkKOcVYWB9cmExu9B4X2lgp11nYQ&s" 
  alt="" 
  width={64} 
  height={64} 
  className="border-2 border-white rounded-full w-16 h-16 object-cover"
/>
        ...
        <div className="w-2/4 bg-white flex flex-col text-center">
          ...
          <div className="p-24 flex flex-col gap-4">
            <h1 className="text-4xl font-semibold text-center flex">Sign in</h1>
