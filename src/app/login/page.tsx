      ...
      <div className="w-2/4 bg-gradient-to-r from-[#224e3a] to-[#31694E]">
        <div className="flex flex-col p-16 gap-8 text-white">
          ...
          <div className="flex gap-4">
            <Image src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQmixgImUBkKOcVYWB9cmExu9B4X2lgp11nYQ&s " alt="" width={14} height={14} className="border-2 border-white rounded-full"/>
