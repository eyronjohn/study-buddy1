    ...
    >
      <div className='text-start'>
        ...
        <input
          ...
          className={`${
            state?.errors.email ? 'border-red-500! bg-red-50!' : 'rounded-md'
          }`}
        />
        {state?.errors.email && (
      ...
      <div className='text-start'>
        ...
        <input
          ...
          className={`${
            state?.errors.password ? 'border-red-500! bg-red-50!' : 'rounded-md'
          }`}
        />
      ...
      <div className='text-center gap-2 flex justify-center'>
        ...
        <Link href="/signup" className='text-green-800 cursor-pointer hover:text-green-900 hover:underline'>Sign In</Link>
      </div>
    </form>
  )
}